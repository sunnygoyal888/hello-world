...
GitHub repository URLs will reference both the username associated with the owner of the repository, as well as the repository name. For example, mindblenders Community is the owner of the infyjobs project repository, so the GitHub URL for that project is:

https://github.com/mindblenders/infyjobs

In the above example, mindblenders  is the username and infyjobs is the repository name.
...
https://github.com/your-username/infyjobs
...
https://github.com/your-username/infyjobs.git
